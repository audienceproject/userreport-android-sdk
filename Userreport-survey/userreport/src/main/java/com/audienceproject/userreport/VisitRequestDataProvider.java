 ...
 */
class VisitRequestDataProvider implements IVisitRequestDataProvider {
    ...
    VisitRequestDataProvider(String mediaId) {
    ...
    public void createVisit(Context context, IVisitRequestReadyCallBack callBack) {
    ...
    public void createInvitation(Context context, IVisitRequestReadyCallBack callBack) {
    ...
    private void loadAaid(Context context, final VisitRequest request, final IVisitRequestReadyCallBack callBack) {
        aaIdProvider.loadAaId(context, new IAaIdLoadedCallback() {
